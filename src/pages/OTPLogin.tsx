        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">Secure access with OTP verification</p>
                </div>
                    ...
                    {step === 'email' ? (
                        ...
                        <form onSubmit={handleRequestOTP} className="space-y-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mb-4">We'll send you a one-time password</p>
                            </div>
                        ...
                        <form onSubmit={handleVerifyOTP} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="000000"
                                    maxLength={6}
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-center text-2xl font-bold tracking-widest"
                                    disabled={isLoading}
                                    autoFocus
                                />
                            </div>
